...
This roadmap describes the evolution of codeAgent's type-resolution layer from a receiver-disambiguation aid into a production-grade static-analysis foundation.
...
For codeAgent, production-grade does **not** mean replacing a language compiler. The target:
