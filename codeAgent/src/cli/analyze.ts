 ...
 * Analyze Command
 *
 * Indexes a repository and stores the knowledge graph in .codeAgent/
 */
...
export const analyzeCommand = async (
  ...
  if (options?.verbose) {
    process.env.codeAgent_VERBOSE = '1';
  }
  ...
  if (process.env.codeAgent_NO_GITIGNORE) {
    console.log('  codeAgent_NO_GITIGNORE is set — skipping .gitignore (still reading .codeAgentignore)\n');
  }
  ...
  try {
    ...
    console.log('\n  Tip: Run `codeAgent setup` to configure MCP for your editor.');
  }
